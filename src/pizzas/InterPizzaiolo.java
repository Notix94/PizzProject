...
public interface InterPizzaiolo {
   ...
   *         client)
   */
  Set<Ingredients> ensembleClients();
   ...
   */
  List<Commande> commandesTraiteesClient(Ingredients client);
   ...
   *         commandées
   */
  Map<Ingredients, Integer> nombrePizzasCommandeesParClient();
   ...
   *         commandées
   */
  Map<Ingredients, Double> beneficeParClient();
